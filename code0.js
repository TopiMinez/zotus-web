...
gdjs.LoadCode.asyncCallback12508916 = function (runtimeScene, asyncObjectsList) {
...
runtimeScene.getAsyncTasksManager().addTask(gdjs.evtTools.runtimeScene.wait(3), (runtimeScene) => (gdjs.LoadCode.asyncCallback12508916(runtimeScene, asyncObjectsList)));
}
}
